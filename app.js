...
(function () {
  ...
  const SUGGESTION_POOLS = {
    about: [
      "Give me the 60-second version of Jerry’s background.",
      "How did Jerry go from Berkeley research to OpenAI hardware?",
      "What kind of computer architect is Jerry?",
      "What themes connect Jerry’s projects?",
      "What does Jerry seem to care about in hardware design?",
      "Summarize Jerry like I’m skimming a hardware resume.",
      "What’s the through-line from BOOM to OpenAI?",
      "What parts of Jerry’s background are most distinctive?",
    ],
    expertise: [
      "Explain Jerry’s expertise in out-of-order CPU design.",
      "Which project should I read first: SonicBOOM, Saturn, or Constellation?",
      "What did Jerry contribute to SonicBOOM?",
      "What’s interesting about Saturn’s microarchitecture?",
      "How does Jerry think about instruction-driven specialization?",
      "What does Jerry know deeply about RISC-V, vectors, and accelerators?",
      "Compare SonicBOOM, Saturn, Gemmini, and Constellation.",
      "What hardware design problems has Jerry spent the most time on?",
    ],
    contact: [
      "What’s the best way to reach Jerry for architecture work?",
      "How should I contact Jerry about research or collaboration?",
      "Where can I find Jerry’s papers, code, and profiles?",
      "Give me Jerry’s public links.",
      "How can I reach Jerry if I want to talk hardware design?",
    ...
    site: [
      ...
      "How are chats cached in the browser?",
      "How does this site combine web search with Jerry’s docs?",
